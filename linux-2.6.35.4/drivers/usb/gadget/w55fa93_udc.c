...
void paser_irq_cep(int irq, struct w55fa93_udc *dev, u32 IrqSt)
{
        ...
        case CEP_DATA_RXD:
                ...
                if (dev->ep0state == EP0_OUT_DATA_PHASE) {
                        ...
                        if (!is_last)
                                ...
                                __raw_writel(0x400, REG_USBD_CEP_IRQ_ENB);		// suppkt int//enb sts completion int
        ...
        case CEP_STS_END:
                __raw_writel(0x4A, REG_USBD_CEP_IRQ_ENB);
...
static void udc_isr_rst(struct w55fa93_udc	*dev)
{
	...
	if(__raw_readl(REG_USBD_OPER) == 2)
